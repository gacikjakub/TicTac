...
public class DiagonalBottomLeftToTopRightWinCheckerTests {
    ...
    public void shouldReturnTrueWhenAchievedRequiredSignAmount(Sign sign) throws IBoard.FieldCheckException {
        ...
        WinChecker winChecker = new DiagonalBottomLeftToTopRightWinChecker(board);
        winChecker.setRequiredSeries(5);
        // when - then
        Assert.assertTrue(winChecker.victoryAchieved(lastCoordinates));
        Assert.assertTrue(winChecker.victoryAchieved(lastCoordinates.getBottomLeft().getBottomLeft()));
    }
    ...
    public void shouldReturnFalseWhenDoNotAchievedRequiredSignAmount(Sign sign) throws IBoard.FieldCheckException {
        ...
        Assert.assertFalse(winChecker.victoryAchieved(lastCoordinates.getBottomLeft().getBottomLeft()));
    }
